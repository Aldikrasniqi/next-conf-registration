...
export const BlurredFormField = memo(
	({
		id,
		label,
		type = 'text',
		...
		<div className="space-y-2">
			...
			<div className="relative">
				...
				<Input
					...
					className={`w-full relative z-10 bg-transparent py-5 ${
	...
	({
		...
		<div className="space-y-2 w-full">
			...
			<div className="relative">
				...
				<div className="flex flex-col items-center justify-center w-full border-2 border-dashed border-gray-600 rounded-lg relative z-10 bg-transparent">
					{selectedImage ? (
